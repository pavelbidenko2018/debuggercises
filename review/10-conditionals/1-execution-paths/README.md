...
## [exercises](../../README.md)/[10-conditionals](../README.md)/1-execution-paths 
...
> pass 
>
> [review source](../../../exercises/10-conditionals/1-execution-paths/1-write-expected.js)
...
> pass 
>
> [review source](../../../exercises/10-conditionals/1-execution-paths/2-write-arguments.js)
...
const _2_expect = 'path 4';
const _2_actual = mystery(false, 'hello');
console.assert(_2_actual === _2_expect, 'Test 2');

// path 2
const _3_expect = 'path 4';
const _3_actual = mystery(true, undefined);
console.assert(_3_actual === _3_expect, 'Test 3');
...
> pass 
>
> [review source](../../../exercises/10-conditionals/1-execution-paths/3-write-function.js)

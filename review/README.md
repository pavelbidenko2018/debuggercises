...
- [/08-functions-201](./08-functions-201/README.md)
  ...
  - [/0-examples](./08-functions-201/0-examples/README.md)
    - [/1-documenting-functions.js](./08-functions-201/0-examples/README.md#1-documenting-functionsjs)  
    - [/2-enforcing-types.js](./08-functions-201/0-examples/README.md#2-enforcing-typesjs)  
    - [/3-behavior-vs-implementation.js](./08-functions-201/0-examples/README.md#3-behavior-vs-implementationjs) - _pass_ 
  - [/1-fill-in-the-blanks](./08-functions-201/1-fill-in-the-blanks/README.md)
    - [/1-write-tests.js](./08-functions-201/1-fill-in-the-blanks/README.md#1-write-testsjs) - _pass_ 
    - [/2-write-tests.js](./08-functions-201/1-fill-in-the-blanks/README.md#2-write-testsjs) - _pass_ 
    - [/3-pass-tests.js](./08-functions-201/1-fill-in-the-blanks/README.md#3-pass-testsjs) - _pass_ 
    - [/4-pass-tests.js](./08-functions-201/1-fill-in-the-blanks/README.md#4-pass-testsjs) - _pass_ 
    - [/5-twins.js](./08-functions-201/1-fill-in-the-blanks/README.md#5-twinsjs) - _pass_ 
    - [/6-twins.js](./08-functions-201/1-fill-in-the-blanks/README.md#6-twinsjs) - _pass_ 
  - [/2-fix-the-bugs](./08-functions-201/2-fix-the-bugs/README.md)
    - [/1.js](./08-functions-201/2-fix-the-bugs/README.md#1js) - _pass_ 
    - [/2.js](./08-functions-201/2-fix-the-bugs/README.md#2js) - _pass_ 
    - [/3.js](./08-functions-201/2-fix-the-bugs/README.md#3js) - _pass_ 
...
- [/10-conditionals](./10-conditionals/README.md)
  - [/0-examples](./10-conditionals/0-examples/README.md)
    - [/1-if-else.js](./10-conditionals/0-examples/README.md#1-if-elsejs) - _pass_ 
    - [/2-if-else-if-else.js](./10-conditionals/0-examples/README.md#2-if-else-if-elsejs) - _pass_ 
    - [/3-sequential-conditionals.js](./10-conditionals/0-examples/README.md#3-sequential-conditionalsjs) - _pass_ 
    - [/4-nested-conditionals.js](./10-conditionals/0-examples/README.md#4-nested-conditionalsjs) - _pass_ 
    - [/5-unreachable-paths.js](./10-conditionals/0-examples/README.md#5-unreachable-pathsjs) - _pass_ 
  - [/1-execution-paths](./10-conditionals/1-execution-paths/README.md)
    - [/1-write-expected.js](./10-conditionals/1-execution-paths/README.md#1-write-expectedjs) - _pass_ 
    - [/2-write-arguments.js](./10-conditionals/1-execution-paths/README.md#2-write-argumentsjs) - _pass_ 
    - [/3-write-function.js](./10-conditionals/1-execution-paths/README.md#3-write-functionjs) - _pass_ 
  - [/2-conditional-bodies](./10-conditionals/2-conditional-bodies/README.md)
    - [/1-write-expected.js](./10-conditionals/2-conditional-bodies/README.md#1-write-expectedjs) - _pass_ 
    - [/2-write-arguments.js](./10-conditionals/2-conditional-bodies/README.md#2-write-argumentsjs) - _pass_ 
    - [/3-write-function.js](./10-conditionals/2-conditional-bodies/README.md#3-write-functionjs) - _pass_ 
...
- [/19-implicit-coercion](./19-implicit-coercion/README.md)
  ...
  - [/3-replicate](./19-implicit-coercion/3-replicate/README.md)
    ...
    - [/remainder.js](./19-implicit-coercion/3-replicate/README.md#remainderjs) - _pass_ 
    - [/unary-minus.js](./19-implicit-coercion/3-replicate/README.md#unary-minusjs) - _pass_ 
